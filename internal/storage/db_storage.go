...
func NewDBStorage(cfg config.Config) (*DBStorage, error) {
	...
	_, err = DB.ExecContext(ctx, `CREATE TABLE IF NOT EXISTS users (id INT GENERATED BY DEFAULT AS IDENTITY, login VARCHAR(255), passw VARCHAR(255), cookie VARCHAR(255), balance FLOAT, withdrawn FLOAT)`)
	if err != nil {
